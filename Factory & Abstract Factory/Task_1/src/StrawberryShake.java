...
public class StrawberryShake implements ShakeCommon {

    @Override
    public void OrderDetails() {
        String orderDescription = "Milk," + "Sugar," + "Strawberry Syrup," + "Strawberry IceCream";
        int orderValue = 200;
        ...
        System.out.println("StrawberryShake " + "ingredients : " + orderDescription);
