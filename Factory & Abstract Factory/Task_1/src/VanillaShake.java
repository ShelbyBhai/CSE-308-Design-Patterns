...
public class VanillaShake implements ShakeCommon{
    @Override
    public void OrderDetails() {
        String orderDescription = "Milk," + "Sugar," + "VanillaFlavour," + "Jello";
        int orderValue = 190;
        ...
        System.out.println("VanillaShake " + "ingredients : " + orderDescription);
