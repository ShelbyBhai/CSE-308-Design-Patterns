...
public class ChocolateShake implements ShakeCommon{

    @Override
    public void OrderDetails() {
        String orderDescription = "Milk," + "Sugar," + "Chocolate Syrup," + "Chocolate IceCream";
        int orderValue = 230;
        ...
        if(choice3.equalsIgnoreCase("y")){
            ...
            System.out.println("Tk 40 added for the candy");
        }
        else{
            System.out.println("No Cookies added!");
        }
        System.out.println("Your Order Details : ");
        System.out.println("ChocolateShake " + "ingredients : " + orderDescription);
        System.out.println("Total value to be paid: " + orderValue);
    }
}
