...
public class CoffeeShake implements ShakeCommon {

    @Override
    public void OrderDetails() {
        String orderDescription = "Milk," + "Sugar," + "Coffee," + "Jello";
        int orderValue = 230;
        ...
        System.out.println("CoffeeShake " + "ingredients : " + orderDescription);
