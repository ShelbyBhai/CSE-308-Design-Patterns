...
public class ComputerC implements ComputerCommon {
    private double cpuC = 3.0;
    private double mmuC = 16;
    @Override
    public void Display() {
        System.out.println("System Initialized with CPU : " + cpuC + "GHz," + "& MMU : " + mmuC + "KB.");
        ...
        if(choice.equalsIgnoreCase("Circle")) {
            ...
            if (r <= 215 && r >= 0) {
                ...
                System.out.println("Resolution of image in this computer is 550*430");
            } else {
        ...
        if(choice.equalsIgnoreCase("Triangle")){
            ...
            if(length1<=430 && length2<=430 && length3<=430){
